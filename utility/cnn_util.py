...
deploy = './material/models/vgg/VGG_ILSVRC_19_layers_deploy.prototxt'
model = './material/models/vgg/VGG_ILSVRC_19_layers.caffemodel'
mean = './material/imagenet/ilsvrc_2012_mean.npy'
